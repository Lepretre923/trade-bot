...
from scanners import (
    ...
    market_direction_score, smart_money_radar
)
...
# ------------------------------------------------
# FLASK SERVER (pour Render / uptime)
# ------------------------------------------------
...
["🧠 Smart Money Radar","📊 Score marché global"],
...
["🐋 Whale radar","📊 Pression marché"],
["🔥 Top movers","📊 Corrélation marché"],

["🎯 Radar stop hunt","⚡ Radar volatilité"],
...
async def message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if t=="💰 BTC Analyse":
    ...
    elif t=="🧠 Smart Money Radar":
        await update.message.reply_text(smart_money_radar(), parse_mode=pm)

    elif t=="📊 Score marché global":
        await update.message.reply_text(market_direction_score(), parse_mode=pm)
        ...
        await update.message.reply_text(fear_greed(), parse_mode=pm)

    elif t=="📉 Funding rate":
        await update.message.reply_text(funding_rate(), parse_mode=pm)

    elif t=="📊 Open interest":
        await update.message.reply_text(open_interest(), parse_mode=pm)

    elif t=="🔥 Liquidation map":
        await update.message.reply_text(liquidation_map(), parse_mode=pm)

    elif t=="📊 Volume profile":
        await update.message.reply_text(volume_profile(), parse_mode=pm)

    elif t=="💵 Stablecoin flow":
        await update.message.reply_text(stablecoin_flow(), parse_mode=pm)

    elif t=="🌍 Marché global":
        await update.message.reply_text(global_market(), parse_mode=pm)
